...
func New(addr string, maxreq int, timeout Duration) Client {
    return Client{
        addr: addr,
...
func (c *Client) do(method string, path string, body string) Result {
...
func (r Result) MustGetFunnyString() string {
